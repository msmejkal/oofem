...
#ifndef misesmattemperature_h
#define misesmattemperature_h
...
///@name Input fields for MisesMatTemperature
//@{
#define _IFT_MisesMatTemperature_Name "misesmattemp"
#define _IFT_MisesMatTemperature_sig0 "sig0"
#define _IFT_MisesMatTemperature_h "h"
#define _IFT_MisesMatTemperature_htype "htype"
#define _IFT_MisesMatTemperature_h_eps "h_eps"
#define _IFT_MisesMatTemperature_h_function_eps "h(eps)"
#define _IFT_MisesMatTemperature_omega_crit "omega_crit"
#define _IFT_MisesMatTemperature_a "a"
#define _IFT_MisesMatTemperature_yieldTol "yieldtol"
//@}
 ...
 */
class MisesMatTemperature : public StructuralMaterial
{
protected:
    /// Reference to the basic elastic material.
    IsotropicLinearElasticMaterialTemperature linearElasticMaterialTemperature;
...
public:
    MisesMatTemperature( int n, Domain *d );
    ...
    const char *giveInputRecordName() const override { return _IFT_MisesMatTemperature_Name; }
    const char *giveClassName() const override { return "MisesMatTemperature"; }
...
////////////////////////
    //double eval_G( GaussPoint *gp, TimeStep *tStep ) const;
    //double eval_K( GaussPoint *gp, TimeStep *tStep ) const;
    ////////////////////////
...
class MisesMatTemperatureStatus : public StructuralMaterialStatus
{
protected:
...
public:
    MisesMatTemperatureStatus( GaussPoint *g );
    ...
    const char *giveClassName() const override { return "MisesMatTemperatureStatus"; }
};
} // end namespace oofem
#endif // misesmat_h
